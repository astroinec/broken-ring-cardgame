...
const DEFINITIONS: Dictionary = {
	...
	&"calibrator_red_pen": {
		...
		&"title": "校准官的红笔",
		&"rarity": "普通",
		&"description": "每场战斗第一次，升级牌使伤害或格挡高于未升级数值时，该牌首个符合条件的结果额外 +3。",
		&"short_description": "首次有效升级伤害或格挡 +3",
	...
	&"blank_epitaph": {
		...
		&"title": "空白墓志铭",
		&"rarity": "稀有 / 纪元",
		&"description": "每场战斗第一次，伤害使生命从至少一半降至低于一半时，先结算伤害，再获得 12 格挡，并随机封存当前手牌中 1 张非状态牌 1 回合；无可封存牌仍消耗本次触发。",
		&"short_description": "首次降至半血以下，伤害后 +12 格挡并封存手牌",
	...
	&"expired_return_bell": {
		...
		&"title": "过期返航铃",
		&"rarity": "首领级",
		&"description": "每场战斗第一次受到致命伤害时，本次伤害改为保留 1 点生命，随后立即裂解一次；《临界许可》可令该次裂解伤害变为 0，否则本次裂解可能致死，即使存活也可能仍被后续裂解杀死。",
